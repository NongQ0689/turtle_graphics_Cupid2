...
//        System.out.println(Arrays.toString(fontNames));
    ...
    public static void main(String[] a)
    {
        ...
        /*Turtle bob = new Turtle();  bob.speed = 0.1 ;
        ...
        bob2.penColor("palevioletred");
        bob2.speed = 0.1 ;
        bob2.penWidth = 4;

        bob3.penColor("crimson");
        bob3.speed = 0.1 ;
        bob3.penWidth = 4;
    ...
    /*
        Q.drawCupid(bob1);
        Q.drawArrow(bob2);
        Q.drawArrowHead(bob3);
 */
        Q.start(100,20);
        Q.drawArrow("palevioletred",4);
        Q.drawCupid("black",2);
        Q.drawArrowHead("crimson",4);
